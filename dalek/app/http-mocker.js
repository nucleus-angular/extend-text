...
.provider('$httpBackend', [function(){
   ...
   */
  return {
    '$get': ['$browser', '$window', '$document', 'httpMocker', function($browser, $window, $document, httpMocker) {
      return createHttpBackend($browser, XHR, $browser.defer, $window.angular.callbacks,
      $document[0], $window.location.protocol.replace(':', ''), httpMocker);
    }]
  };

  function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol, httpMocker) {
